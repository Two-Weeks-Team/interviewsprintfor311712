...
> Build a study and interview-prep web service that turns a role target into a tactical sprint plan with drills, review ca

---

## Overview

Users need a clearer way to act on interview skill sprint and learning planner without starting from a blank product spec.
...
```yaml
name: interview-sprint-forge
services:
  - name: api
    github:
      repo: Two-Weeks-Team/interview-sprint-forge
      branch: master
