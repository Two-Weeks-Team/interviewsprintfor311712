...
const APP_NAME = "Interview Sprint Forge";
const TAGLINE = "Build a study and interview-prep web service that turns a role target into a tactical sprint plan with drills, review ca";
const FEATURE_CHIPS = ["sprint lane", "drill card", "review block", "confidence checkpoint"];
const PROOF_POINTS = ["structured prep plan", "practice sequence", "saved revision roadmap", "the first screen shows a real plan structure"];
const SURFACE_LABELS = {"hero": "editorial production board", "workspace": "sprint lane", "result": "drill card", "support": "saved content batches", "collection": "hook card board"};
...
const DEFAULT_STATS = [{"label": "structured prep plan", "value": "4"}, {"label": "saved content batches", "value": "0"}, {"label": "Readiness score", "value": "88"}];
const READY_TITLE = "assembling a multi-post creator batch live";
const READY_DETAIL = "Show the system turning messy input into a usable interview skill sprint and learning planner artifact in one pass. / assembling a multi-post creator batch live / turning a rough angle into a publish-ready workflow";
const COLLECTION_TITLE = "Editorial Production Board stays visible after each run.";
const SUPPORT_TITLE = "Saved Content Batches";
const REFERENCE_TITLE = "Review Block";
...
const SAMPLE_ITEMS = ["structured prep plan", "practice sequence", "saved revision roadmap", "Hook variant"];
const REFERENCE_OBJECTS = ["sprint lane", "drill card", "review block", "confidence checkpoint", "hook card"];
